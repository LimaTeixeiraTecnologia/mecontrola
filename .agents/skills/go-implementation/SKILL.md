...
20. Para qualquer adapter nos quatro caminhos canonicos (`handlers/`, `consumers/`, `jobs/handlers/`, `producers/`): usar a Matriz R-ADAPTER-001.3 em `.claude/rules/go-adapters.md` para selecionar referencias por tipo, em vez de carregar por diff_signal generico.
