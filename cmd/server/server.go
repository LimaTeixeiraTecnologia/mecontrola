...
func Run() error {
	...
	agentsModule, err := agents.NewModule(agents.Deps{
		...
		Audio: agents.AudioConfig{
			Enabled:         cfg.AgentConfig.AudioEnabled,
			MetaAccessToken: cfg.WhatsAppConfig.AccessToken,
			STTModel:        cfg.AgentConfig.STTModel,
			STTTimeout:      cfg.AgentConfig.STTTimeout,
			MaxDuration:     cfg.AgentConfig.AudioMaxDuration,
			MaxBytes:        cfg.AgentConfig.AudioMaxBytes,
			MaxCostMicrousd: cfg.AgentConfig.AudioMaxCostMicrousd,
			MinConfidence:   cfg.AgentConfig.AudioMinConfidence,
			UncertainReply:  cfg.AgentConfig.AudioUncertainReply,
			RejectedReply:   cfg.AgentConfig.AudioRejectedReply,
		},
