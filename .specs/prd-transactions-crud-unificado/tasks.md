...
<!-- spec-hash-techspec: 514e7aeab589ff0004be448763c94e4ba381e170b5605f89b666becceb5aa3dd -->
...
|---|--------|--------|-------------|---------------|--------|
| 1.0 | VOs e Commands base (PaymentMethod VR/VA, sentinels credit_card) | pending | — | — | — |
| 2.0 | TransactionWorkflow enriquecido + DecideDelete + entity/eventos | pending | 1.0 | Com 5.0 | — |
| 3.0 | Migration 000003 + repositórios unificados | pending | 2.0 | Não | — |
| 4.0 | Use cases unificados create/update/delete | pending | 2.0, 3.0, 5.0 | Não | — |
| 5.0 | Validação de categorias (raiz, filha direta, kind↔direction) | pending | 1.0 | Com 2.0 | — |
| 6.0 | HTTP unificado + remoção de card-purchase + OpenAPI | pending | 4.0 | Com 7.0 | — |
| 7.0 | Refactor do agente para CRUD unificado | pending | 4.0 | Com 6.0 | mastra |
| 8.0 | Wiring, integração/e2e, observabilidade e gates | pending | 4.0, 6.0, 7.0 | Não | — |
