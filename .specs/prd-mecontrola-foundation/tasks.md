...
| 6.0 | `internal/infrastructure/http` — server + middleware stack + health endpoints + Problem Details mapper | done | 4.0, 5.0 | Não | — |
...
| 10.0 | CI/CD workflows + cmd_integration_test + coverage PR comment + runbooks + README + branch protection | done | 3.0, 6.0, 7.0, 8.0, 9.0 | Não | `pull-request`, `semantic-commit` |
