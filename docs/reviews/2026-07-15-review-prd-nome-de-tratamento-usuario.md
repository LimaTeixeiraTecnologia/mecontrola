...
```text
Use @.claude/skills/review/ de forma criteriosa e sem flexibilização, validando estritamente contra .specs/prd-nome-de-tratamento-usuario
...
```xml
<goal>
Obter um veredito final `APPROVED` para a implementacao relacionada a `.specs/prd-nome-de-tratamento-usuario/`, com conformidade total e comprovada contra PRD, techspec, ADRs, criterios de aceite, DoD e regras de negocio, sem falsos positivos, sem lacunas, sem gaps e sem ressalvas.
</goal>

<context>
- Repositorio local: `/Users/jailtonjunior/Git/mecontrola`
- Especificacao alvo: `.specs/prd-nome-de-tratamento-usuario/`
- Documentos minimos obrigatorios:
  - `.specs/prd-nome-de-tratamento-usuario/prd.md`
  - `.specs/prd-nome-de-tratamento-usuario/techspec.md`
  - todos os ADRs presentes em `.specs/prd-nome-de-tratamento-usuario/`
...
<task>
Execute a skill `@.claude/skills/review/` de forma estrita e deterministica contra a implementacao atual relacionada a `.specs/prd-nome-de-tratamento-usuario/`.
...
2. Leia obrigatoriamente `prd.md`, `techspec.md` e todos os ADRs em `.specs/prd-nome-de-tratamento-usuario/`.
