...
func TestIsNewCompleteOperation_SemPrefixoMonetario(t *testing.T) {
	scenarios := []struct {
		...
		{text: "recebi 500 de freelance", want: true},
		{text: "gastei 20", want: true},
		{text: "gastei 1.500 no mercado", want: true},
		{text: "recebi 5000 de freelance", want: true},
		{text: "1", want: false},
		{text: "2", want: false},
		{text: "sim", want: false},
		{text: "não", want: false},
		{text: "nubank", want: false},
		{text: "comprei em 2024", want: false},
		{text: "ganhei na loteria", want: false},
