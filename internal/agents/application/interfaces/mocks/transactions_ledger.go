...
// GetDaySummary provides a mock function for the type TransactionsLedger
func (_mock *TransactionsLedger) GetDaySummary(ctx context.Context, userID uuid.UUID, day string) (interfaces.DaySummary, error) {
	ret := _mock.Called(ctx, userID, day)

	if len(ret) == 0 {
		panic("no return value specified for GetDaySummary")
	}

	var r0 interfaces.DaySummary
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, string) (interfaces.DaySummary, error)); ok {
		return returnFunc(ctx, userID, day)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, string) interfaces.DaySummary); ok {
		r0 = returnFunc(ctx, userID, day)
	} else {
		r0 = ret.Get(0).(interfaces.DaySummary)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, string) error); ok {
		r1 = returnFunc(ctx, userID, day)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// TransactionsLedger_GetDaySummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetDaySummary'
type TransactionsLedger_GetDaySummary_Call struct {
	*mock.Call
}

// GetDaySummary is a helper method to define mock.On call
//   - ctx context.Context
//   - userID uuid.UUID
//   - day string
func (_e *TransactionsLedger_Expecter) GetDaySummary(ctx any, userID any, day any) *TransactionsLedger_GetDaySummary_Call {
	return &TransactionsLedger_GetDaySummary_Call{Call: _e.mock.On("GetDaySummary", ctx, userID, day)}
}

func (_c *TransactionsLedger_GetDaySummary_Call) Run(run func(ctx context.Context, userID uuid.UUID, day string)) *TransactionsLedger_GetDaySummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *TransactionsLedger_GetDaySummary_Call) Return(daySummary interfaces.DaySummary, err error) *TransactionsLedger_GetDaySummary_Call {
	_c.Call.Return(daySummary, err)
	return _c
}

func (_c *TransactionsLedger_GetDaySummary_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, day string) (interfaces.DaySummary, error)) *TransactionsLedger_GetDaySummary_Call {
	_c.Call.Return(run)
	return _c
}
...
// SearchEditCandidates provides a mock function for the type TransactionsLedger
func (_mock *TransactionsLedger) SearchEditCandidates(ctx context.Context, userID uuid.UUID, q interfaces.EditCandidateQuery) ([]interfaces.Entry, error) {
	...
	var r0 []interfaces.Entry
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, interfaces.EditCandidateQuery) ([]interfaces.Entry, error)); ok {
		return returnFunc(ctx, userID, q)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, interfaces.EditCandidateQuery) []interfaces.Entry); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, interfaces.EditCandidateQuery) error); ok {
...
// TransactionsLedger_SearchEditCandidates_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SearchEditCandidates'
type TransactionsLedger_SearchEditCandidates_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - userID uuid.UUID
//   - q interfaces.EditCandidateQuery
func (_e *TransactionsLedger_Expecter) SearchEditCandidates(ctx any, userID any, q any) *TransactionsLedger_SearchEditCandidates_Call {
	return &TransactionsLedger_SearchEditCandidates_Call{Call: _e.mock.On("SearchEditCandidates", ctx, userID, q)}
}

func (_c *TransactionsLedger_SearchEditCandidates_Call) Run(run func(ctx context.Context, userID uuid.UUID, q interfaces.EditCandidateQuery)) *TransactionsLedger_SearchEditCandidates_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 interfaces.EditCandidateQuery
		if args[2] != nil {
			arg2 = args[2].(interfaces.EditCandidateQuery)
		}
		run(
			arg0,
			arg1,
...
func (_c *TransactionsLedger_SearchEditCandidates_Call) Return(entrys []interfaces.Entry, err error) *TransactionsLedger_SearchEditCandidates_Call {
	_c.Call.Return(entrys, err)
	return _c
}

func (_c *TransactionsLedger_SearchEditCandidates_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, q interfaces.EditCandidateQuery) ([]interfaces.Entry, error)) *TransactionsLedger_SearchEditCandidates_Call {
	_c.Call.Return(run)
	return _c
}
