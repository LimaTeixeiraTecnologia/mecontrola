...
func BuildResolveCardTool(cards interfaces.CardManager) tool.ToolHandle {
	...
	return tool.NewTool[ResolveCardInput, ResolveCardOutput]("resolve_card", "Resolve o cartão de crédito do usuário pelo apelido informado, retornando o identificador para uso em registros no cartão.", in, out, buildResolveCardExec(cards))
}
