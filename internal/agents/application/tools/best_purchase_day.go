...
func BuildBestPurchaseDayTool(cards interfaces.CardManager) tool.ToolHandle {
	...
	return tool.NewTool[BestPurchaseDayInput, BestPurchaseDayOutput]("best_purchase_day", "Calcula o melhor dia para fazer compras em um cartão dado o banco e o dia de vencimento.", in, out, buildBestPurchaseDayExec(cards))
}
