...
type BudgetRepository interface {
	...
	GetActiveByUserCompetence(ctx context.Context, userID uuid.UUID, c valueobjects.Competence) (entities.Budget, error)
	...
	ListFutureByUserCompetence(ctx context.Context, userID uuid.UUID, from valueobjects.Competence) ([]entities.Budget, error)
