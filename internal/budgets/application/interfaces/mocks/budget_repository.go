...
func (_mock *BudgetRepository) GetActiveByUserCompetence(ctx context.Context, userID uuid.UUID, c valueobjects.Competence) (entities.Budget, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetActiveByUserCompetence")
	}
...
func (_c *BudgetRepository_GetActiveByUserCompetence_Call) Run(run func(ctx context.Context, userID uuid.UUID, c valueobjects.Competence)) *BudgetRepository_GetActiveByUserCompetence_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *BudgetRepository_GetActiveByUserCompetence_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID, c valueobjects.Competence) (entities.Budget, error)) *BudgetRepository_GetActiveByUserCompetence_Call {
	_c.Call.Return(run)
	return _c
}
