...
func (_mock *Handler) Handle(ctx context.Context, event events.Event) error {
...
func (_c *Handler_Handle_Call) Run(run func(ctx context.Context, event events.Event)) *Handler_Handle_Call {
...
func (_c *Handler_Handle_Call) RunAndReturn(run func(ctx context.Context, event events.Event) error) *Handler_Handle_Call {
	_c.Call.Return(run)
	return _c
}
