...
const FallbackParseError = "Não entendi direito. Pode reformular? Posso te ajudar com cartões, orçamento e lançamentos."

const (
	defaultListCardsLimit   = 200
	fallbackParseError      = FallbackParseError
...
const FallbackUsecaseError = "Tive uma instabilidade para consultar isso agora. Tente de novo em instantes 🙏"

const fallbackUsecaseError = FallbackUsecaseError

const RegisterUnavailableText = registerUnavailableText
