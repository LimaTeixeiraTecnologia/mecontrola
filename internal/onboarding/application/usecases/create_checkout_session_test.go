...
func (u *unitOfWorkCheckout) Do(ctx context.Context, fn func(context.Context, database.DBTX) (entities.MagicToken, error), _ ...uow.Option) (entities.MagicToken, error) {
	return fn(ctx, nil)
}
