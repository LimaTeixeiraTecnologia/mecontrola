...
var (
	...
	ErrOnboardingAlreadyActive      = errors.New("onboarding: session already active")
	ErrOnboardingNotReadyToComplete = errors.New("onboarding: session not ready to complete")
)
