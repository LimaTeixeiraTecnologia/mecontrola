...
var (
	...
	ErrInputPurchasedAtRequired    = errors.New("purchased_at: não pode ser vazio")
	...
	ErrInputInstallmentsOutOfRange = errors.New("installments_total: deve estar entre 1 e 24")
	ErrInputVersionRequired        = errors.New("version: deve ser maior que zero")
	ErrInputTotalAmountRequired    = errors.New("total_amount_cents: deve ser maior que zero")
