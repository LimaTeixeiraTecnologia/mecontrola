...
Funcionalidade: Fatura do cartão
  ...
  Cenário: obter fatura do cartão após criação de card-purchase retorna 200
    ...
    E que existe uma card-purchase de 4000 centavos em 1 parcela no cartão em "2026-03-05"
